...
def find_scatters(
    ...
    final_scatter4 = np.sqrt( # 1 et 4 are equivalent
       sum([sum([x**2, y**2, z**2]) for x, y, z in final_positions_xyz - np.average(
...
current_avg_position_scatter_xyz = (29.3, 14.0, 9.0) # Typical of β-Pictoris
...
avg_velocity_scatter_xyz = (2.2, 1.2, 1.0) # Typical of β-Pictoris
