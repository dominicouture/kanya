...
group.draw_age_distribution('covariance_ξηζ', index=0, fit='normal', adjusted=True, number_of_bins=80, forced=True)
group.draw_age_distribution('covariance_ξηζ', index=0, fit='skewnormal', adjusted=False, number_of_bins=60, forced=True)
group.draw_age_distribution('covariance_ξηζ', index=0, fit='skewnormal', adjusted=False, number_of_bins=60, forced=True)
...
group.draw_trajectory('position', 'both', metric='covariance_ξηζ', index=0, forced=True)
...
group.draw_scatter('position', 'ξηζ', '3x3', age=0, errors=True, mst=True, ellipses=True, forced=True)
group.draw_scatter('position', 'ξηζ', '2x3', age=0, errors=True, mst=True, ellipses=True, forced=True)
group.draw_scatter('position', 'ξηζ', '3x2', age=0, errors=True, mst=True, ellipses=True, forced=True)
