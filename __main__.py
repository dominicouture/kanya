...
group.draw_scatter('position', 'xyz', '2x2', age=-5, errors=True, mst=False, ellipses=True, forced=True)
...
group.create_average_kinematics_time_table(forced=True, save=True, machine=False)
group.create_star_kinematics_time_table(15, show=False, save=True, machine=False)
